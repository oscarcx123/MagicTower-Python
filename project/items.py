...
ITEMS_DATA = {
	...
	"itemEffect": {
		"redJewel": "self.PlayerCon.attack += RED_JEWEL",
		"blueJewel": "self.PlayerCon.defend += BLUE_JEWEL",
		"greenJewel": "self.PlayerCon.mdefend += GREEN_JEWEL",
		"yellowJewel": "self.PlayerCon.attack += YELLOW_JEWEL\nself.PlayerCon.defend += YELLOW_JEWEL\nself.PlayerCon.mdefend += YELLOW_JEWEL * GREEN_JEWEL\nself.PlayerCon.hp += YELLOW_JEWEL * RED_POTION",
		"redPotion": "self.PlayerCon.hp += RED_POTION",
		"bluePotion": "self.PlayerCon.hp += BLUE_POTION",
		"yellowPotion": "self.PlayerCon.hp += GREEN_POTION",
		"greenPotion": "self.PlayerCon.hp += YELLOW_POTION",
		"sword0": "pass",
		"sword1": "self.PlayerCon.attack += SWORD_1",
		"sword2": "self.PlayerCon.attack += SWORD_2",
		"sword3": "self.PlayerCon.attack += SWORD_3",
		"sword4": "self.PlayerCon.attack += SWORD_4",
		"sword5": "self.PlayerCon.attack += SWORD_5",
		"shield0": "pass",
		"shield1": "self.PlayerCon.defend += SHIELD_1",
		"shield2": "self.PlayerCon.defend += SHIELD_2",
		"shield3": "self.PlayerCon.defend += SHIELD_3",
		"shield4": "self.PlayerCon.defend += SHIELD_4",
		"shield5": "self.PlayerCon.defend += SHIELD_5",
		"superPotion": "self.PlayerCon.hp *= 2",
		"moneyPocket": "self.PlayerCon.gold += 500"
	},
	"itemEffectTip": {
